...
public class ItemDaoImpl extends GenericDaoImpl<Item> implements ItemDao {
    ...
    public List<Item> findItemCriteria(Integer initialPrice, User buyer, User seller) {
        ...
        if ((seller != null) && (initialPrice != null)) {
            ...
            Predicate sellerPredicate = criteriaBuilder.equal(userRoot, seller);

            Predicate pricePredicate = criteriaBuilder.greaterThan(itemRoot.get("initialPrice"), initialPrice);

            Predicate sellerMatchPredicate = criteriaBuilder.and(sellerPredicate, pricePredicate);
